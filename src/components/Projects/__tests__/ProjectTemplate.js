...
import { ProjectLinks, ProjectPreview, Tags } from 'src/components/Projects/ProjectTemplate.style';
...
test('should have title and description', () => {
  ...
  expect(getByText(/Project description/i)).toHaveTextContent('Project description')
})
  ...
  let { getByText, getByTitle, debug } = render(
    <ThemeProvider theme={themelight}>
      <ProjectTemplate
        ...
        links={
          <ProjectLinks>
            <Button as={'a'} to={node.fields.slug}>Case Study</Button>
